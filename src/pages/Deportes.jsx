...
const Deportes = () => {
    ...
    const [deportesItems, setDeportesItems] = useState(getProductsByCategory('Deportes')); // Guardamos el estado de los productos
    ...
    const handleAddToCart = (item) => {
        ...
        const updatedItems = deportesItems.map((product) => {
        ...
        setDeportesItems(updatedItems); // Actualizamos el inventario local
    ...
    return (
        <div>
            <h1>Productos de Deportes</h1>
            <div className="product-list">
                {deportesItems.length > 0 ? (
