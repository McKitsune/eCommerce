...
const Hogar = () => {
    ...
    const [hogarItems, setHogarItems] = useState(getProductsByCategory('Hogar')); // Guardamos el estado de los productos
    ...
    const handleAddToCart = (item) => {
        ...
        const updatedItems = hogarItems.map((product) => {
        ...
        setHogarItems(updatedItems); // Actualizamos el inventario local
